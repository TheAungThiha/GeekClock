...
public class SettingsActivity extends PreferenceActivity implements
	...
	static final String KEY_SNOOZE_SHAKE_TIMES = "snooze_shake_times";
	static final String KEY_DISMISS_SHAKE_TIMES = "dismiss_shake_times";
	...
	public boolean onPreferenceChange(Preference pref, Object newValue) {
		...
		}else if (KEY_SNOOZE_SHAKE_TIMES.equals(pref.getKey())) {
			final ListPreference listPref = (ListPreference) pref;
			final int idx = listPref.findIndexOfValue((String) newValue);
			listPref.setSummary("Shake " + listPref.getEntries()[idx] + " to snooze");
		}else if (KEY_DISMISS_SHAKE_TIMES.equals(pref.getKey())) {
			final ListPreference listPref = (ListPreference) pref;
			final int idx = listPref.findIndexOfValue((String) newValue);
			listPref.setSummary("Shake " + listPref.getEntries()[idx] + " to dismiss");
		}
		return true;
	}
	...
	private void refresh() {
		...
		listPref = (ListPreference) findPreference(KEY_SNOOZE_SHAKE_TIMES);
		listPref.setSummary("Shake " + listPref.getEntry() + " to snooze");
		listPref.setOnPreferenceChangeListener(this);
		
		listPref = (ListPreference) findPreference(KEY_DISMISS_SHAKE_TIMES);
		listPref.setSummary("Shake " + listPref.getEntry() + " to dismiss");
		listPref.setOnPreferenceChangeListener(this);
	}
}
